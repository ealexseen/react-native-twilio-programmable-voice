...
public class IncomingCallNotificationWorker extends Worker {
  private static final String TAG = "IncomingCallNotificationWorker";

  public IncomingCallNotificationWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    super(context, workerParams);
  }

  public static CallInvite deserializeFromJson(String jsonString) {
      Gson gson = new Gson();
      return gson.fromJson(jsonString, CallInvite.class);
  }
  ...
  @Override
    ...
    String callInviteJson = (String) map.get(Constants.INCOMING_CALL_INVITE);
    CallInvite callInvite = deserializeFromJson(callInviteJson);
    int notificationId = (int) map.get(Constants.INCOMING_CALL_NOTIFICATION_ID);
    String action = (String) map.get("CALL_ACTION");
	...
	private Notification createNotification(CallInvite callInvite, int notificationId, int channelImportance) {
      ...
      Intent intent = new Intent(getApplicationContext(), getMainActivityClass(context));
